...
env WINEPREFIX=$SCRIPTDIR/.wine WINEARCH=win64 WINEDEBUG=-all ./winetricks corefonts 
env DISPLAY=:5.0 WINEPREFIX=$SCRIPTDIR/.wine WINEARCH=win64 WINEDEBUG=-all ./winetricks -q vcrun2017 
