...
$Manifest = Invoke-WebRequest -Uri 'https://cdn.centcomm.spacestation14.com/builds/wizards/manifest.json' | ConvertFrom-Json
...
Invoke-WebRequest -Uri $DownloadUrl -OutFile "SS14.Server_win-x64.zip"
